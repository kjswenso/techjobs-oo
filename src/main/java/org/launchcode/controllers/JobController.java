...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors, RedirectAttributes redirectAttributes) {
        ...
        CoreCompetency jobComp = jobData.getCoreCompetencies().findById(jobForm.getCompetenciesId());
        PositionType jobPos = jobData.getPositionTypes().findById(jobForm.getPositionId());
